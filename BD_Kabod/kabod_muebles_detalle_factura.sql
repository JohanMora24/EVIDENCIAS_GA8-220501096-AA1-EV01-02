...
CREATE TABLE `detalle_factura` (
  ...
  CONSTRAINT `detalle_factura_ibfk_2` FOREIGN KEY (`Id_Mueble`) REFERENCES `mueble` (`Id_Mueble`)
...
INSERT INTO `detalle_factura` VALUES (600,500,'10',2,3400000);
...
-- Dump completed on 2025-07-20  3:11:06
